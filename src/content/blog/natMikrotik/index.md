---
title: "NAT on MikroTik Explained: Source NAT, Destination NAT, and Masquerade"
description: "Your laptop has a private IP that the internet has never heard of. NAT is the reason you can still browse freely. Here is how srcnat, dstnat, and masquerade work, with a real MikroTik lab walkthrough."
date: "2026-04-29"
category: "Networking"
...
![Topology](/blog/posts/natMikrotik/topologi.png "Topology")
...
![DHCP Client](/blog/posts/natMikrotik/dhcpclient.png "DHCP Client")
...
![IP Setup](/blog/posts/natMikrotik/setupip.png "IP Setup")
...
![IP DHCP Server Leases](/blog/posts/natMikrotik/leases.png "IP DHCP Server Leases")

On the client side, `ipconfig` should show:

![IPConfig](/blog/posts/natMikrotik/ipconfig.png "IPConfig")
...
![Ping rejaka.id](/blog/posts/natMikrotik/pingrejaka.png "Ping rejaka.id")

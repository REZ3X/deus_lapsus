...
description: "NAT gets your clients online. Firewall controls what they can actually do once they are there. Here is a full two-router lab walkthrough covering static routing, NAT, and firewall filter rules with real test results."
date: "2026-04-29"
category: "Networking"
coverImage: ""
lastModified: "2026-05-03"
tags: ["MikroTik", "Firewall", "Networking", "MTCNA", "Routing", "NAT", "Access Control"]
---
...
![Topology](/blog/posts/mikrotikFirewall/topology.png "Topology")
...
![Router1 ether5](/blog/posts/mikrotikFirewall/r1e5.png "Router1 ether5")
...
![Router1 ether6](/blog/posts/mikrotikFirewall/r1e6.png "Router1 ether6")
...
![Router2 ether1](/blog/posts/mikrotikFirewall/r2e1.png "Router2 ether1")
...
![Router2 ether2](/blog/posts/mikrotikFirewall/r2e2.png "Router2 ether2")
...
![Router1 DHCP Server Lease](/blog/posts/mikrotikFirewall/r1dhcp.png "Router1 DHCP Server Lease")

to confirm the client received an address. On the client side, running `ip a` should show something like:

![IP Address Client](/blog/posts/mikrotikFirewall/r1dhcp2.png "IP Address Client")
...
![Router1 Default Route](/blog/posts/mikrotikFirewall/r1route1.png "Router1 Default Route")
...
![Router2 Return Route](/blog/posts/mikrotikFirewall/r2route1.png "Router2 Return Route")
...
![Router1 Client Ping](/blog/posts/mikrotikFirewall/ping.png "Router1 Client Ping")
...
![Router2 Firewall Rule Tab - General](/blog/posts/mikrotikFirewall/r2firewall1.png "Router2 Firewall Rule Tab General")
...
![Router2 Firewall Rule Tab - Action](/blog/posts/mikrotikFirewall/r2firewall2.png "Router2 Firewall Rule Tab Action")
...
![Router2 Firewall Rule Tab - General 2](/blog/posts/mikrotikFirewall/r2firewall3.png "Router2 Firewall Rule Tab General 2")
...
![Router2 Firewall Rule Tab - Action 2](/blog/posts/mikrotikFirewall/r2firewall4.png "Router2 Firewall Rule Tab Action 2")
...
![Router2 Firewall Rules List](/blog/posts/mikrotikFirewall/r2firewall5.png "Router2 Firewall Rules List")
...
![Router2 Client Web Browsing](/blog/posts/mikrotikFirewall/r2firewall6.png "Router2 Client Web Browsing")
...
![Router2 Client Ping Fail](/blog/posts/mikrotikFirewall/r2firewall7.png "Router2 Client Ping Fail")
...
![Router2 Client Ping Success](/blog/posts/mikrotikFirewall/r2firewall8.png "Router2 Client Ping Success")

...
description: "Step-by-step guide to installing Node Version Manager (NVM) and Node.js on Windows."
date: "2025-07-27"
category: "Tutorial"
...
![Download NVM Setup](/blog/posts/nvmWindows/nvmsetup.png "Download NVM Setup")

### Install NVM

1. Run the installer from File Explorer > Downloads.

![File Explorer](/blog/posts/nvmWindows/dooubleclick.png "File Explorer")
![Smart Screen](/blog/posts/nvmWindows/smartscreen.png "Smart Screen")
![Account Control](/blog/posts/nvmWindows/accountcontrol.png "Account Control")

2. Accept the agreement and click “Next”.

![Agreement](/blog/posts/nvmWindows/agreement.png "Agreement")

3. Use the default installation paths.

![NVM Installation Folder](/blog/posts/nvmWindows/nvminstallfolder.png "NVM Installation Folder")
![Active Version](/blog/posts/nvmWindows/activeversion.png "Active Version")

4. For notification settings, stick with the default.

![Notification Setting](/blog/posts/nvmWindows/notification.png "Notification Setting")

5. Wait for installation.
6. Finish (don’t tick “Open with PowerShell”).

![Finish](/blog/posts/nvmWindows/finish.png "Finish")
...
![nvm -v](/blog/posts/nvmWindows/nvmv.png "nvm -v")
...
![nvm install](/blog/posts/nvmWindows/nvminstall.png "nvm install")
...
![nvm use error](/blog/posts/nvmWindows/nvmerror.png "nvm use error")
...
![NVM Root Path](/blog/posts/nvmWindows/nvmrootpath.png "NVM Root Path")

_If AppData is hidden, enable "Hidden items" from View tab._

![NVM Moved](/blog/posts/nvmWindows/nvmmoved.png "NVM Moved")
...
![settings.txt](/blog/posts/nvmWindows/settings.png "settings.txt")

3. Open Environment Variables, update all `nvm`-related paths to `C:\nvm`.

![Environment Variable](/blog/posts/nvmWindows/envvar.png "Environment Variable")
![Environment Path Change](/blog/posts/nvmWindows/env1.png "Environment Path Change")
![Environment Path Change](/blog/posts/nvmWindows/env2.png "Environment Path Change")
...
![nvm use rerun](/blog/posts/nvmWindows/nvmuse1.png)
![nvm use rerun](/blog/posts/nvmWindows/nvmuse2.png)
![nvm use rerun](/blog/posts/nvmWindows/nvmuse3.png)
...
![Node Checking](/blog/posts/nvmWindows/nodecheck.png "Node Checking")
